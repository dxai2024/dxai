...
log_file_name = 'output_log/log_'+data_name+'_'+running_name+'.log'

os.system('echo cuda device id: '+cuda_id+' >> ' + log_file_name)

cmd = 'CUDA_VISIBLE_DEVICES='+cuda_id+' python main.py --mode train\
      --sample_dir expr/samples_'+data_name+'_'+running_name+'\
      --checkpoint_dir expr/checkpoints_'+data_name+'_'+running_name+'\
